...
#define X_LEG
	...
	#ifdef  HUADRUINO
	byte pins[] = {0,0, 0, 0,	//hPan_PIN, hTilt_PIN, tPan_PIN, 0,
					 rFL_PIN, rFR_PIN, rHR_PIN, rHL_PIN,//rFL_PIN, rFR_PIN, rHR_PIN, rHL_PIN,
...
#define panF 10
#define tiltF 10
#define sRF 5   //shoulder roll factor
